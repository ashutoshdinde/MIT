...
import RedBallSprite from '../sprites/RedBallSprite';
import GreenBallSprite from '../sprites/GreenBallSprite';
...
export const SpriteImage = ({ spriteName, styles, handleClick }) => {
    switch (spriteName) {
        ...
        case "RedBall":
                return <RedBallSprite styles={styles} onClick={handleClick} />
        case "GreenBall":
                return <GreenBallSprite styles={styles} onClick={handleClick} />
        default:
            return <></>
    }
}
